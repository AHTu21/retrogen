...
| **2-я (MINOR)** | Крупное обновление в `main` | **Автоматически** при merge, если merge «большой» |
| **3-я (PATCH)** | Небольшое обновление в `main` | **Автоматически** при merge, если merge «малый» |
