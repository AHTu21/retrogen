...
export function SettingsHubWindow({ d, isLight, accentStyle, title, nav, children, toolbar, saveStatus }: Props) {
  ...
  const shellClass = isFullscreen
    ...
    ? "fixed inset-0 z-[850] flex min-h-0 flex-col"

    : "fixed z-[850] flex min-h-0 flex-col overflow-hidden rounded-2xl ring-1 ring-[var(--ph-border)]";
  ...
  const shellTheme = isLight
    ...
    ? "border-zinc-200/80 bg-white text-zinc-900 shadow-[var(--ph-shadow)]"

    : "border-zinc-700/80 bg-zinc-900 text-zinc-100 shadow-2xl shadow-black/40";



  return (

    <div className="fixed inset-0 z-[840] antialiased" aria-hidden={false}>
