...
export const PROFILE_NAV: ProfileNavItem[] = [
  ...
  { id: "notepad", label: "Блокнот", hint: "Таблицы, списки с вложенностью, полный экран и шаблоны" },
  {
    id: "notifications",
    label: "Уведомления",
  ...
  },
  {
    id: "organization",
    label: "Организация",
    hint: "Team+, SSO и свой бренд — предпросмотр корпоративных возможностей",
    guestHidden: true,
    navBadge: "Скоро",
  },
  {
    id: "billing",
    label: "Тариф",
    hint: "Сравнение планов «Бесплатный», «Команда» и «Корпоративный»",
    guestHidden: true,
    navBadge: "Скоро",
  },
